...
y=J.v8(z)
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new Q.em("red",new Q.RJ(1))),y.Sg),[H.Kp(y,0)]).Zz()
y=J.Vg(document.querySelector("#download-as-png"))
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new Q.Lb(z)),y.Sg),[H.Kp(y,0)]).Zz()},"$0","Pc",0,0,56],
RJ:{
"^":"Tp:101;a",
