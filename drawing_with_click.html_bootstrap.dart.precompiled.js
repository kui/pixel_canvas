...
return this.zO},
$isOd:true}}],["app_bootstrap","drawing_with_click.html_bootstrap.dart",,E,{
"^":"",
...
gmN:function(a){return new W.DM(a,a).t(0,"pixelclick")},
...
J.qQ(w[x],y,b)
z.Hi(y,x,v,b)},
bu:function(a){return"Pixel("+this.x+","+this.y+","+H.d(this.na)+")"}}}],["pixel_canvas.example.drawing_with_click_html_0","drawing_with_click.html.0.dart",,Q,{
"^":"",
E2:function(){var z,y
A.Ok()
z=document.querySelector("pixel-canvas")
y=J.v8(z)
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new Q.waE("red",new Q.RJ(1))),y.Sg),[H.Kp(y,0)]).Zz()
y=J.Vg(document.querySelector("#download-as-png"))
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new Q.Ore(z)),y.Sg),[H.Kp(y,0)]).Zz()},
RJ:{
"^":"Tp:103;a",
$1:function(a){return this.a===J.uk(a)},
$isEH:true},
waE:{
"^":"Tp:45;b,c",
$1:[function(a){var z,y,x
z=J.RE(a)
if(this.c.$1(J.UQ(z.gey(a),"origin"))!==!0)return
y=J.UQ(z.gey(a),"pixel")
z=J.RE(y)
x=this.b
if(J.de(z.gih(y),x))z.sih(y,null)
else z.sih(y,x)},"$1",null,2,0,null,1,"call"],
$isEH:true},
Ore:{
"^":"Tp:45;d",
$1:[function(a){J.v2(this.d,"pixel-canvas-sample.png")},"$1",null,2,0,null,1,"call"],
...
l7:[function(a,b,c,d){J.kH(c,new A.n1(a,b,c,d,J.JR(a.IX),P.op(null,null,null,null)))},"$3","gnu",6,0,109],
...
w=$.wt().aV.t(0,x)
v=a.IX.gBj()
if(v!=null&&v.tg(0,w))this.Id(a,w)}},"$1","gqY",2,0,110,95],
...
y=this.u0(a)
this.uP=y
if(b!==!0&&this.rs!=null&&!J.de(z,y))this.Co(this.uP)},function(a){return this.yR(a,!1)},"lW","$2$skipChanges","$1","gew",2,3,117,118,58,119],
...
OC:{
"^":"Tp:45;a,b,c",
$1:[function(a){if(J.nE(a,new K.IC(this.c))===!0)this.a.DX(this.b)},"$1",null,2,0,null,120,"call"],
$isEH:true},
IC:{
"^":"Tp:45;d",
...
fk:{
"^":"Tp:45;a,b,c",
$1:[function(a){if(J.nE(a,new K.v6(this.c))===!0)this.a.DX(this.b)},"$1",null,2,0,null,120,"call"],
$isEH:true},
v6:{
"^":"Tp:45;d",
$1:[function(a){return!!J.x(a).$isqI&&J.de(a.oc,this.d)},"$1",null,2,0,null,121,"call"],
...
ja:{
"^":"Tp:45;e,f,UI",
$1:[function(a){if(J.nE(a,new K.ey(this.UI))===!0)this.e.DX(this.f)},"$1",null,2,0,null,120,"call"],
$isEH:true},
ey:{
"^":"Tp:45;bK",
$1:[function(a){return!!J.x(a).$isHA&&J.de(a.G3,this.bK)},"$1",null,2,0,null,121,"call"],
$isEH:true},
fa:{
...
jh:{
"^":"Tp:122;a,b,c",
$1:[function(a){if(J.nE(a,new K.e3(this.c))===!0)this.a.DX(this.b)},"$1",null,2,0,null,120,"call"],
$isEH:true},
e3:{
"^":"Tp:45;d",
$1:[function(a){return!!J.x(a).$isqI&&J.de(a.oc,this.d)},"$1",null,2,0,null,121,"call"],
...
GS:{
"^":"a;",
WU:[function(a,b,c){return new U.zX(b,c)},"$2","gvH",4,0,123,1,39]},
hw:{
"^":"a;",
$ishw:true},
EZ:{
...
fr:{
"^":"a;",
DV:[function(a){return J.CX(a,this)},"$1","gGM",2,0,124,98]},
cfS:{
"^":"fr;",
xn:function(a){},
...
x=[]
w=y.gVl(z)
H.VM(new W.xC(0,w.uv,w.Ph,W.VF(new M.nl(x)),w.Sg),[H.Kp(w,0)]).Zz()
y=y.gi9(z)
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new M.ik(x)),y.Sg),[H.Kp(y,0)]).Zz()
...
if($desc instanceof Array)$desc=$desc[1]
RJ.prototype=$desc
function waE(b,c){this.b=b
this.c=c}waE.builtin$cls="waE"
if(!"name" in waE)waE.name="waE"
$desc=$collectedClasses.waE
if($desc instanceof Array)$desc=$desc[1]
waE.prototype=$desc
function Ore(d){this.d=d}Ore.builtin$cls="Ore"
